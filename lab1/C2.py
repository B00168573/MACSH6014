...
def cipherFunc(baseNum, powerNum, modNum, expectedNum):
    ...
    print("Is the result of (\t", baseNum, " to the power of \t", powerNum, ") then mod by \t", modNum, " equals to \t", expectedNum, "? \t", finalResult == expectedNum)
    return finalResult

finalResult = cipherFunc(8, 5, 269, 219)
